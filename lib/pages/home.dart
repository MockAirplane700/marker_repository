...
class _HomeState extends State<Home> {
  ...
  List<Marker> markers = Markers.getMarkers();
  late double width;
  late double height;
  ...
  Widget build(BuildContext context) {
        ...
        Card(
          ...
          child: GestureDetector(
            onTap: () {
              ...
              Navigator.push(context, MaterialPageRoute(builder: (context)=> ViewMarker(marker: value)));
            },
            child: Container(
    ...
    return Scaffold(
      ...
      body: Center(
        child: markers.isNotEmpty ? SingleChildScrollView(
